...
namespace common.config {
    ...
    commonModule.config(
        ...
        (ngTemplateCoreProvider: ngTemplate.core.config.CoreConfig) => {
            ...
            ngTemplateCoreProvider.config.dropdownWidgets.singleSelectBuilder = (attrs: ngTemplate.core.widgets.IDropdownWidgetAttributes): JQuery => {
                ...
                if (attrs.allowBlank) {
                 ...
                 //uiSelectMatch.attr('searchEnabled', 'false');
